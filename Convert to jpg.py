...
def copyFiles(src, dest):
    ...
    # this function is what copies the files to the dest
...
def main():
    ...
    src = os.path.abspath("C:"+os.path.sep+"Users"+ os.path.sep + user+"\AppData\Local\Packages\Microsoft.Windows.ContentDeliveryManager_cw5n1h2txyewy\LocalState\Assets")
